                      ...
                      <div class="d-flex justify-content-between align-items-center">
                        ...
                        <ul class="listing d-none d-lg-block" id="navigation">
                          <li class="single-list">
                            <a href="javascript:void(0)" class="single active">Home <i class="ri-arrow-down-s-line"></i></a>
                            <ul class="submenu">
                              <li class="single-list">
                          ...
                          <li class="single-list">
                            ...
                            <ul class="submenu">
                              ...
                              <li class="single-list">
                                <a href="blog-details.html" class="single">Blog Details</a>
                              </li>
                              <li class="single-list">
                              ...
                              <li class="single-list">
                                <a href="shopping-cart.html" class="single">Shopping Cart</a>
                              </li>
                              <li class="single-list">
                                <a href="checkout.html" class="single">Checkout</a>
                              </li>
                              <li class="single-list">
                                <a href="javascript:void(0)" class="single">Login<i class="ri-arrow-right-s-line"></i></a>
                                <ul class="submenu">
                                  <li class="single-list">
                                  ...
                                  <li class="single-list">
                                    <a href="forgot-pass.html" class="single">Forgot Password</a>
                                  </li>
                                  <li class="single-list">
                                    <a href="verification.html" class="single">Verification</a>
                                  </li>
                                  <li class="single-list">
                                    <a href="new-password.html" class="single">New Password</a>
                                  </li>
                                </ul>
                              </li>
                              ...
                              <li class="single-list">
                                <a href="privacy-policy.html" class="single">privacy policy</a>
                              </li>
                              <li class="single-list">
                ...
                <li class="single-list">
                  <a href="javascript:void(0)">
                    <div class="search-flex">
                      ...
                      <div class="content">
                        <h4 class="title line-clamp-1">Modern studio apartment design bedroom and living space</h4>
                        <p class="pera line-clamp-2">Wonderful evening escapade starting at Madinat Jumeirah to the musical fountains to see another. Wonderful evening escapade starting at Madinat Jumeirah to the musical fountains to see another</p>
                      </div>
                    </div>
                  </a>
                </li>
                <li class="single-list">
                  <a href="javascript:void(0)">
                    <div class="search-flex">
                      ...
                      <div class="content">
                        <h4 class="title line-clamp-1">Comfortable armchair in a room decorated</h4>
                        <p class="pera line-clamp-2">Give a great end to your day in Dubai with our premium evening Red Dune Desert Safari. Give a great end to your day in Dubai with our premium evening Red Dune Desert Safari.</p>
                      </div>
                    </div>
                  </a>
                </li>
                <li class="single-list">
                  <a href="javascript:void(0)">
                    <div class="search-flex">
                      ...
                      <div class="content">
                        <h4 class="title line-clamp-1">Cafe with coffee tables as sofas plants and shelves</h4>
                        <p class="pera line-clamp-2">Admission to Dubai’s biggest, multicultural festival park with replicas of iconic landmarks. Admission to Dubai’s biggest, multicultural festival park with replicas of iconic landmarks</p>
                      </div>
                    </div>
                  </a>
                </li>
  ...
  <main>
    ...
    <section class="hero-area-bg hero-padding1">
              ...
              <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                  ...
                  <div class="hero-image mx-auto wow fadeInUp" data-wow-delay="0.2s">
                    <img src="/images/hero/hero-banner-1.png" alt="img" />
                  </div>
                </div>
                <!-- Single Slider -->
                <div class="swiper-slide">
                  ...
                  <div class="hero-image mx-auto wow fadeInUp" data-wow-delay="0.2s">
                    <img src="/images/hero/04.png" alt="img" />
                  </div>
                </div>
                <!-- Single Slider -->
                <div class="swiper-slide">
                  ...
                  <div class="hero-image mx-auto wow fadeInUp" data-wow-delay="0.2s">
                    <img src="/images/hero/03.png" alt="img" />
                  </div>
                </div>
              </div>
      ...
      <div class="shape-one heartbeat2">
        <img src="/images/hero/hero-shape.png" alt="img" />
      </div>
      <!-- shape 02 -->
    ...
    <section class="goal-area position-relative">
        ...
        <div class="row g-4">
          <div class="col-xxl-3 col-md-4 col-sm-6">
            <div class="goal-card wow fadeInUp" data-wow-delay="0.0s">
              <div class="circle-icon">
                <img src="/images/goal/icon-1.png" alt="img" />
              </div>
              <a href="javascript:void(0)">
                <h4 class="title line-clamp-1 text-color-primary">Original Product</h4>
                <p class="pera text-color-tertiary line-clamp-2">There are many variations of passages of our Lorem Ipsum available but the.</p>
              </a>
            </div>
          </div>
          <div class="col-xxl-3 col-md-4 col-sm-6">
            <div class="goal-card wow fadeInUp" data-wow-delay="0.0s">
              <div class="circle-icon">
                <img src="/images/goal/icon-2.png" alt="img" />
              </div>
              <a href="javascript:void(0)">
          ...
          <div class="col-xxl-3 col-md-4 col-sm-6">
            <div class="goal-card wow fadeInUp" data-wow-delay="0.1s">
              <div class="circle-icon">
                <img src="/images/goal/icon-3.png" alt="img" />
              </div>
              <a href="javascript:void(0)">
          ...
          <div class="col-xxl-3 col-md-4 col-sm-6">
            <div class="goal-card wow fadeInUp" data-wow-delay="0.2s">
              <div class="circle-icon">
                <img src="/images/goal/icon-4.png" alt="img" />
              </div>
              <a href="javascript:void(0)">
      ...
      <div class="shape routedOne">
        <img src="/images/goal/shape.png" alt="img" />
      </div>
    </section>
    <!-- End-of goal-->
              ...
              <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                  <div class="product-card feature-card h-calc">
                    ...
                    <div class="product-img-card feature-img-card">
                      <a href="shop-details.html" class="zoomImg">
                        <img src="/images/product/product-2.png" alt="img" />
                      </a>
                      <div class="special-icon">
                        <button class="icon-btn">
                          <svg xmlns="http://www.w3.org/2000/svg" width="21" height="19" viewBox="0 0 21 19" fill="none">
                ...
                <div class="swiper-slide">
                  <div class="product-card feature-card h-calc">
                    ...
                    <div class="product-img-card feature-img-card">
                      <a href="shop-details.html" class="zoomImg">
                        <img src="/images/product/product-3.png" alt="img" />
                      </a>
                      <div class="special-icon">
                        <button class="icon-btn">
                          <svg xmlns="http://www.w3.org/2000/svg" width="21" height="19" viewBox="0 0 21 19" fill="none">
                ...
                <div class="swiper-slide">
                  <div class="product-card feature-card h-calc">
                    ...
                    <div class="product-img-card feature-img-card">
                      <a href="shop-details.html" class="zoomImg">
                        <img src="/images/product/product-4.png" alt="img" />
                      </a>
                      <div class="discount-badge">
          ...
          <div class="col-lg-12">
            <div class="section-with-button wow fadeInLeft" data-wow-delay="0.0s">
              <div class="section-title position-relative">
                <h4 class="title">Choose The <span class="outline-text">Categories</span> That You Want</h4>
                <div class="shape routedOne">
                  <img src="/images/icon/title-shape.png" alt="img" />
                </div>
              </div>
              <div class="text-center d-block">
                <a href="shop.html" class="outline-pill-btn">
          ...
          <div class="col-xl-6">
            <div class="category-card h-calc gallery-one wow fadeInUp" data-wow-delay="0.0s">
              <a href="shop.html" class="zoomImg">
                <img src="/images/category/category-1.png" alt="img" />
              </a>
            ...
            <div class="row g-4">
              <div class="col-xl-12 col-lg-6">
                <div class="category-card h-calc gallery-two wow fadeInUp" data-wow-delay="0.1s">
                  <a href="shop.html" class="zoomImg">
                    <img src="/images/category/category-2.png" alt="img" />
                  </a>
              ...
              <div class="col-xl-12 col-lg-6">
                <div class="category-card h-calc gallery-two wow fadeInUp" data-wow-delay="0.2s">
                  <a href="shop.html" class="zoomImg">
                    <img src="/images/category/category-3.png" alt="img" />
                  </a>
                  <div class="collection-card">
                    <a href="shop.html">
        ...
        <div class="row g-4">
          <div class="col-xl-4 col-md-6">
            <div class="category-card h-calc gallery-three wow fadeInUp" data-wow-delay="0.0s">
              <a href="shop.html" class="zoomImg">
                <img src="/images/category/category-4.png" alt="img" />
              </a>
          ...
          <div class="col-xl-4 col-md-6">
            <div class="category-card h-calc gallery-three wow fadeInUp" data-wow-delay="0.1s">
              <a href="shop.html" class="zoomImg">
                <img src="/images/category/category-5.png" alt="img" />
              </a>
              <div class="collection-card sm">
                <a href="shop.html">
          ...
          <div class="col-xl-4 col-md-6">
            <div class="category-card h-calc gallery-three wow fadeInUp" data-wow-delay="0.2s">
              <a href="shop.html" class="zoomImg">
                <img src="/images/category/category-6.png" alt="img" />
              </a>
              <div class="collection-card sm">
                <a href="shop.html">
        ...
        <div class="row g-4">
          <div class="col-xl-12">
            <div class="deals-card">
              <div class="row align-items-center g-4">
                <div class="col-xl-6">
                  <div class="deals-banner">
                    <img src="/images/gallery/deals-1.png" alt="img" />
                  ...
                  <div class="deals-content">
                    ...
                    <div class="section-title">
                      <h4 class="title">
                        ...
                        <span class="outline-text">Shopping</span> Today
                      </h4>
                    </div>
              ...
              <div class="shape-one heartbeat2">
                <img src="/images/gallery/deal-shape-3.svg" alt="img" />
              </div>
              <div class="shape-two routedOne">
                <img src="/images/gallery/deal-shape-4.png" alt="img" />
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="section-with-button">
              <div class="section-title position-relative wow fadeInUp" data-wow-delay="0.0s">
                <h4 class="title">
                  ...
                  <span class="outline-text">Collections</span>
                </h4>
                <div class="shape routedOne">
                  <img src="/images/icon/title-shape.png" alt="img" />
                </div>
            ...
            <div class="row g-4">
              <div class="col-xxl-6 col-xl-4 col-sm-6">
                <div class="product-card best-product-card">
                  ...
                  <div class="product-img-card best-product-img-card">
                    <a href="shop-details.html" class="zoomImg">
                      <img src="/images/product/product-5.png" alt="img" />
                    </a>
                    <div class="special-icon">
                      <button class="icon-btn">
                        <svg xmlns="http://www.w3.org/2000/svg" width="21" height="19" viewBox="0 0 21 19" fill="none">
              ...
              <div class="col-xxl-6 col-xl-4 col-sm-6">
                <div class="product-card best-product-card">
                  ...
                  <div class="product-img-card best-product-img-card">
                    <a href="shop-details.html" class="zoomImg">
                      <img src="/images/product/product-6.png" alt="img" />
                    </a>
                    <div class="discount-badge">
                      <span class="percentage">- 35%</span>
                    </div>
        ...
        <div class="row g-4">
          <div class="col-xxl-3 col-xl-4 col-sm-6">
            <div class="product-card best-product-card">
              ...
              <div class="product-img-card best-product-img-card">
                <a href="shop-details.html" class="zoomImg">
                  <img src="/images/product/product-7.png" alt="img" />
                </a>
                <div class="special-icon">
                  <button class="icon-btn">
                    <svg xmlns="http://www.w3.org/2000/svg" width="21" height="19" viewBox="0 0 21 19" fill="none">
          ...
          <div class="col-xxl-3 col-xl-4 col-sm-6">
            <div class="product-card best-product-card">
              ...
              <div class="product-img-card best-product-img-card">
                <a href="shop-details.html" class="zoomImg">
                  <img src="/images/product/product-8.png" alt="img" />
                </a>
                <div class="discount-badge">
          ...
          <div class="col-xxl-3 col-xl-4 col-sm-6">
            <div class="product-card best-product-card">
              ...
              <div class="product-img-card best-product-img-card">
                <a href="shop-details.html" class="zoomImg">
                  <img src="/images/product/product-9.png" alt="img" />
                </a>
                <div class="special-icon">
                  <button class="icon-btn">
                    <svg xmlns="http://www.w3.org/2000/svg" width="21" height="19" viewBox="0 0 21 19" fill="none">
          ...
          <div class="col-xxl-3 col-xl-4 col-sm-6">
            <div class="product-card best-product-card">
              ...
              <div class="product-img-card best-product-img-card">
                <a href="shop-details.html" class="zoomImg">
                  <img src="/images/product/product-10.png" alt="img" />
                </a>
                <div class="special-icon">
                  <button class="icon-btn">
                    <svg xmlns="http://www.w3.org/2000/svg" width="21" height="19" viewBox="0 0 21 19" fill="none">
              ...
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                  <div class="news-card">
                    ...
                    <div class="news-content">
                      <a href="blog-details.html">
                        <h4 class="news-title line-clamp-2">Modern studio apartment design bedroom and living space</h4>
                      </a>
                    </div>
                    <a href="blog-details.html" class="read-more-text"
                      >Read More
                ...
                <div class="swiper-slide">
                  <div class="news-card">
                    ...
                    <div class="news-content">
                      <a href="blog-details.html">
                        <h4 class="news-title line-clamp-2">Comfortable armchair in a room decorated</h4>
                      </a>
                    </div>
                    <a href="blog-details.html" class="read-more-text"
                      >Read More
                ...
                <div class="swiper-slide">
                  <div class="news-card">
                    ...
                    <div class="news-content">
                      <a href="blog-details.html">
                        <h4 class="news-title line-clamp-2">Cafe with coffee tables as sofas plants and shelves</h4>
                      </a>
                    </div>
                    <a href="blog-details.html" class="read-more-text"
                      >Read More
              ...
              <div class="left-wrapper">
                ...
                <div class="subscription-input-section">
                  ...
                  <button type="submit" class="subscribe-btn">
                    <span class="btn-text">Subscribe</span><span class="icon"><i class="ri-arrow-right-line"></i></span>
                  </button>
                </div>
              </div>
              <div class="right-wrapper">
                ...
                <div class="download-app">
                  <a href="javascript:void(0)" target="_blank" class="wow fadeInUp" data-wow-delay="0.0s">
                    <img src="/images/icon/google-play.png" alt="img" />
                  </a>
                  <a href="javascript:void(0)" target="_blank" class="wow fadeInUp" data-wow-delay="0.1s">
                    <img src="/images/icon/app-store.png" alt="img" />
                  </a>
                </div>
              </div>
            </div>
          ...
          <div class="row g-4">
            <div class="col-xl-3 col-lg-4 col-sm-6">
              <div class="single-footer-caption">
                <div class="footer-tittle">
                  ...
                  <p class="pera">Etoshi is an exciting contemporary brand which focuses on high-quality products graphics with a British style</p>
            ...
            <div class="col-xl-6">
              <div class="footer-menu-section">
                <div class="logo logo-large light-logo">
                  <a href="index.html"><img src="/images/logo/logo-dark.png" alt="logo" /></a>
                </div>
            ...
            <div class="col-xl-2 offset-xl-1 col-lg-4 col-sm-6">
              <div class="single-footer-caption">
                <div class="footer-tittle">
                  ...
                  <ul class="listing">
                    <li class="single-list">
                      <a href="javascript:void(0)" class="single">My Orders</a>
                    </li>
                    <li class="single-list">
                      <a href="javascript:void(0)" class="single">My Credit Slips</a>
                    </li>
                    <li class="single-list">
                      <a href="javascript:void(0)" class="single">My Addresses</a>
                    </li>
                    <li class="single-list">
                      <a href="javascript:void(0)" class="single">My Personal Info</a>
                    </li>
                  </ul>
                </div>
              </div>
