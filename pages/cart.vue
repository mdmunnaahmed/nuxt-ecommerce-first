      ...
      <div class="row g-4">
        <div class="col-xl-4 col-md-6">
          <div class="mini-card h-100">
            ...
            <div class="body">
              <p class="pera">
                There are many variations of passages of Lorem Ipsumis suffered
                alteration in some form, by injected huvmour, or look even
                slightly believable.
              </p>
              <div class="formbar">
                <input
            ...
            <div class="body">
              <div class="mb-20">
                <div class="country-dropdown">
                  <select name="country" class="select2"></select>
                </div>
              </div>
              <div class="mb-20">
                <input
